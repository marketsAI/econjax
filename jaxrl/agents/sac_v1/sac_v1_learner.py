...
def _update_jit(
    ...
    new_value, value_info = update_v(
        key, new_actor, new_critic, value, temp, batch, True
    )
    ...
    return (
        ...
        new_target_value,
        new_temp,
        {**critic_info, **value_info, **actor_info, **alpha_info},
    )
...
class SACV1Learner(object):
    def __init__(
        ...
        target_value = Model.create(value_def, inputs=[critic_key, observations])
